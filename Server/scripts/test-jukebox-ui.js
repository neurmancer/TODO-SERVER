...
function client(catalogue) {
    const elements = Object.fromEntries(['musicBtn', 'nextSongBtn', 'music-player', 'music-status']
...
(async () => {
    ...
    console.log('Passed: silent startup, tap playback, independent listeners, seeking, resume, shuffle, end/error handling, retry and empty-library refresh');
